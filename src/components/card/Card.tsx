...
const Card = ({ id, date, title, imgSrc, text, variant, isFiltered }: CardComponentProps) =>  {
          ...
          <div className={`card-large ${cardClassName}`}>
            ...
            <div className="card-actions-wrapper">
              <div className="card-actions"> 
                      ...
                      <p className="likes-counter">{dislikes}</p>
              </div> 
              <div className="card-actions"> 
                      <a href="#" onClick={handleBookmark} className={isBookmarked ? 'bookmarked' : 'neutral'}><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32"><path fill="currentColor" d="M24 4v22.75l-7.1-3.59l-.9-.45l-.9.45L8 26.75V4zm0-2H8a2 2 0 0 0-2 2v26l10-5l10 5V4a2 2 0 0 0-2-2"/></svg></a>
