...
import DotsLink from "../icons/Icons"
  ...
  const handleNavigate = () => {
    ...
    return (
      <div className="modal-pop-up">
        ...
        {selectedPost.variant && (
          <div className="pop-up-post-content">
            {selectedPost.imgSrc && <img className="pop-up-post-content-image" src={selectedPost.imgSrc} alt={selectedPost.title} />}
            <h3 className="pop-up-post-content-header">{selectedPost.title}</h3>
            <p className="pop-up-post-content-date">{selectedPost.date}</p>
            <p className="pop-up-post-content-text">{selectedPost.text}</p>
            <div className="pop-up-post-content-link" onClick={handleNavigate}>
          <DotsLink /></div>
          </div>
        )}
        {/* // <Card {...selectedPost} isFiltered={false} variant={selectedPost.variant} /> */}
        </div>
        </div>
    )
  }
